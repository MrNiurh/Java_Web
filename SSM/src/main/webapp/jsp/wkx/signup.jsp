    ...
    <div id="main">
        <div class="login-wrap">
            <div id="signin" class="rl-modal">
                <div class="rl-modal-header">
                    <h1>
                        ...
                        <span class="xa-showSignup">注册</span>
                    </h1>
                </div>
                    ...
                    <div class="clearfix">
                        <form id="signup-form01" autocomplete="off">
                            <div class="rlf-group pr">
                                <input type="text" value maxlength="37" name="email" autocomplete="off" class="xa-emailOrPhone ipt ipt-email js-own-name"
                            ...
                            <div class="rlf-group clearfix js-verify-row" style="display:none">
                            ...
                            <div class="rlf-group rlf-appendix  clearfix" style="line-height: initial">
                                <label for="auto-signin" class="rlf-autoin l" hidefocus="true">
                                    <input type="checkbox" checked="checked" class="auto-cbx" id="auto-signin01">
                                    7天内自动登录

                                </label>
                                <a href="javascript:void(0)" class="rlf-forget r" target="_blank" hidefocus="true">无法登录</a>
                            ...
                            <div class="rlf-group clearfix">
                                <input type="button" value="登录" id="btnin" hidefocus="true" class="moco-btn moco-btn-red moco-btn-lg btn-full xa-login">
                            </div>
                        </form>
                    </div>
                </div>
                <div class="rl-model-footer">
                    <div class="pop-login-sns clearfix">
                        ...
                        <a href="javascript:void(0)" hidefocus="true"  class="pop-sns-weibo l"><i class="imv2-weibo"></i></a>
                        <a href="javascript:void(0)" hidefocus="true"  class="pop-sns-weixin l"><i class="imv2-weixin"></i></a> 
                        <a href="javascript:void(0)" hidefocus="true" class="pop-sns-qq l"><i class="imv2-qq"></i></a>
                    </div>
                </div>
            </div>
            <div id="signup" class="rl-modal" style="display:none">
                    <div class="rl-modal-header">
                        <h1>
                            <span class="xa-showSignup">登录</span>
                        ...
                        <div class="clearfix">
                            <form id="signup-form02" autocomplete="off">
                                <div class="rlf-group pr">
                                    ...
                                    <input type="text" value maxlength="37" name="email" autocomplete="off" class="ipt ipt-phone"
                                ...
                                <div class="rlf-group pr">
                                    ...
                                    <input type="password" name="password" data-validate="require-password" class="ipt ipt-pwd js-loginPassword js-pass-pwd"
                                        ...
                                        <a href="javascript:void(0)" hidefocus="true" class="verify-img-wrap js-verify-refresh"><img class="verify-img" src=""></a>
                                        <a href="javascript:void(0)" hidefocus="true" class="icon-refresh js-verify-refresh"></a>
                                ...
                                <div class="rlf-group rlf-appendix  clearfix" style="line-height: initial">
                                    <label for="auto-signin" class="rlf-autoin l" hidefocus="true">
                                        <input type="checkbox" checked="checked" class="auto-cbx" id="auto-signin02">
                                        同意<a href=""id="ipt-agreement" >《慕课网注册协议》</a>
                                ...
                                <p class="rlf-tip-globle color-red" id="signin-globle-error"></p>
                                <div class="rlf-group clearfix">
                                    <input type="button" value="注册" id="btnup" hidefocus="true" class="moco-btn moco-btn-red moco-btn-lg btn-full xa-login">
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="rl-model-footer">
                        <div class="pop-login-sns clearfix">
                            ...
                            <a href="javascript:void(0)" hidefocus="true"  class="pop-sns-weibo r"><i class="imv2-weibo"></i></a>
                            <a href="javascript:void(0)" hidefocus="true"  class="pop-sns-weixin r"><i class="imv2-weixin"></i></a> 
                            <a href="javascript:void(0)" hidefocus="true" class="pop-sns-qq r"><i class="imv2-qq"></i></a>
                        </div>
                    </div>
                </div>
        </div>
