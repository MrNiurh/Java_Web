				...
				<div class="user_functions">
					<div class="user_info">
						...
						<div class="user_binding">
							<a href="" class="user_identitys"><img
								src="<%=path%>/imgs/whp/personlogo.png" class="bind_logo"
					...
					<div class="user_ops">
						...
						<a href="<%=basePath%>user/setbindsns" class="user_op_a">账号绑定<span
							...
							href="javascript:void(0)" class="user_op_a  on">实名认证<span
							class="user_op_logo">></span></a> <a
							href="<%=basePath%>user/certificate" class="user_op_a">学籍认证<span
							class="user_op_logo">></span></a> <a
							href="<%=basePath%>user/address" class="user_op_a">收件认证<span
					...
					<div class="itemBoxs">
						<div class="itemBox">
							...
							<dl class="auth-des">
								...
								<dd>
									3、如若账号还未绑定手机，建议你提前<a class="red"
										href="//www.imooc.com/user/setbindsns" target="_blank">绑定手机</a>；
								</dd>
								<dd>4、实名认证审核完成后，将无法修改和删除，请谨慎填写；</dd>
								<dd>
									5、实名认证审核完成后，系统将自动发放10个积分作为奖励；<a class="red"
										href="//www.imooc.com/u/6182006/credit" target="_blank">查看积分</a>
								</dd>
								<dd>
									6、你需要准备身份证照片（需正反两面），请确保证件照片清晰可见，严禁PS，具体可参考<a class="red"
										href="//www.imooc.com/help/cate/14" target="_blank">实名认证常见问题</a>；
								</dd>
