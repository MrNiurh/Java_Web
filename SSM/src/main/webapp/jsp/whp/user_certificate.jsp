    ...
    <div class="container-fluid">
        ...
        <div class="mainer">
                ...
                <div class="user_functions">
                    <div class="user_info">
                        ...
                        <div class="user_ops">
                            ...
                            <a href="javascript:void(0)" class="user_op_a on">学籍认证<span class="user_op_logo">></span></a>
                        ...
                        <div class="itemBoxs">
                            <div class="itemBox">
                                <div class="certificate_form">
                                    <div class="x_info">
                                        所有填写信息必须与学籍证明相同，如填写错误将无法通过
                                    </div>
                                    <div class="user_input_details">
                                        <div class="x_in_label">姓名：</div>
                                        <div class="x_in_input">
                                            <input type="text" placeholder="输入您的真实姓名" class="user_input" maxlength="10" name="realname">
                                        </div>
                                        <div class="error"></div>
                                    </div>
                                    <div class="user_input_details">
                                        ...
                                        <div class="x_in_input">
                                            <input type="text" placeholder="输入你所在的院校名称" class="user_input" maxlength="10" name="realname">
                                        </div>
                                        <div class="error"></div>
                                    </div>
                                    <div class="user_input_details">
                                        ...
                                        <div class="x_in_input">
                                            <select id="" class="user_input" name="schooltime" hidefocus="true">
                                    ...
                                    <div class="user_input_details">
                                        ...
                                        <div class="x_in_input">
                                            <select id="" class="user_input" name="education" hidefocus="true">
                                                <option value="">请选择</option>
                                    ...
                                    <div class="user_input_details">
                                        ...
                                        <div class="x_in_input">
                                            <div class="x_upload_wrap">
                                                <input id="imgfile" type="file" name="fileField" class="x_upload js_x_upload">
                                                <div class="x_upload_cont">
                                                    
                                                    <p style="text-indent: 10px;">+选择上传文件</p>
                                                </div>
                                            </div>
                                            <a class="x_ra" target="_blank" href="//www.imooc.com/help/detail/67">怎样申请学籍证明</a>
                                        </div>
                                    </div>
                                     <div class="user_input_details">
            ...
            <p>• 学籍认证主要是证明你是在校大学生，同时享受慕课网推出的 <a href='#'>慕课网学生优惠计划</a> 的服务；</p>-->
                                        ...
                                        <p>• 学籍认证审核完成后，将无法修改和删除，请谨慎填写。同时系统将自动发放10个积分作为奖励；<a target="_blank" href="/u/6182006/credit">查看积分</a>；</p>
                                        <p>• 上传学籍证明文件格式为PDF或JPG格式。请确保学籍文件清晰可见，具体可参考实名认证 <a target="_blank" href="//www.imooc.com/help/detail/67">常见问题</a>；</p>
