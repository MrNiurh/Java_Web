		...
		<div class="mainer">
			<div class="container">
				...
				<div class="function_dis">
					<div class="oplog-tip">
						上次登录时间：2018-11-25 14:18:43&nbsp;&nbsp;&nbsp;地点： <a
							href="/user/oplog">查看最近操作记录</a> &nbsp;&nbsp;用户ID：6182006 <span
							class="tip-close pull-right js-tip-close">×</span>
					</div>
					<div class="common-title">
						账号绑定 <span class="title-tips">完成<b class="color-red">3/4</b></span>
						<a href="/help/cate/17" style="text-decoration: none;"
							class="pull-right main_edit" target="_blank"><i
...
"></i>常见问题</a>
					...
					<div class="itemBoxs">
						<div class="itemBox">
							<div class="left">
								<img class="mailbox" src="<%=path%>/imgs/whp/eamillogo.png"
									alt=""></i>
							</div>
							<div class="center">
								<p>
									<span class="font1"><b>邮箱</b></span> <span class="font3">
									</span> <span class="font4 color-red">未绑定（绑定邮箱可得一积分） </span>
								</p>
						...
						<div class="itemBox">
							...
							<div class="center">
								<p>
									<span class="font1"><b>手机</b></span> <span class="font3">
									</span> <span class="font4 color-red">176******29 </span>
								</p>
						...
						<div class="itemBox">
							...
							<div class="center">
								<p>
									<span class="font1"><b>密码</b></span> <span class="font3">
									</span> <span class="font4 color-red">已设置 </span>
								</p>
						...
						<div class="itemBox">
							...
							<div class="center">
								<p>
									<span class="font1"><b>社交账号</b></span>

								</p>
								<p class="font2">绑定第三方账号，可以直接登录，还可以将内容同步到以下平台，与更多好友分享</p>
								<div class="bind_users">
									<div class="inner-i-box">
										<img src="<%=path%>/imgs/whp/weixin_mw.png" alt=""
											class="bind_user_logo">
										<div class="bind_user_details">
											<p class="font3">
												<b>微信</b>
											</p>
											<p class="font4 color-red">未绑定</p>
											<a href="" class="font4 bind_user_a"
												style="text-decoration: none;">添加绑定</a>
										</div>
									</div>
									<div class="inner-i-box">
										<img src="<%=path%>/imgs/whp/weibo.png" alt=""
											class="bind_user_logo">
										<div class="bind_user_details">
											<p class="font3">
												<b>微博</b>
									...
									<div class="inner-i-box">
										<img src="<%=path%>/imgs/whp/QQ.png" alt=""
											class="bind_user_logo">
										<div class="bind_user_details">
											<p class="font3">
												<b>qq</b>
