	...
	<div class="wrap">
		...
		<div class="slider">
			<ul>
				...
				<li><a href="<%=basePath%>user/War" class="active"> <span>实战</span><b
						class="icon-drop_right"></b>
				</a></li>
		...
		<div class="u-container">
			...
			<div class="c-tab clearfix">
				<div class="tool-left l" style="margin-top: 30px; height: 40px;">
					...
					<a href="<%=basePath%>user/War" class="sort-item active"
						style="margin-right: 30px; font-size: 14px; color: #7f8082">我的实战</a>
					<a href="<%=basePath%>user/Shou1" class="sort-item "
			...
			<div class="not-conts"
				...
				你最近没有实战课程，可以先<a href=" " class="find-course" style="color: red;">去找找课程</a>
			</div>
