...
<head>
<meta charset="utf-8">
<title>${user.username }的就业班</title>
...
<body>
		...
		<div class="wrap">
			...
			<div class="slider">
				<ul>
					...
					<li><a href="<%=basePath%>user/Update" class="active"> <span>就业班</span><b
							class="icon-drop_right"></b>
					</a></li>
			...
			<div class="u-container">
				...
				<div class='plans-main'>
					<h2>我的就业班</h2>
					<p class='notattend'>
						您没有参加任何就业班,可以先<a target="_blank" href=' ' class='red'>去找找就业班课程</a>
					</p>
				</div>
				<!-- share-->
			</div>
	...
	<div id="J_GotoTop" class="elevator">
		...
		<a href="/user/feedback" class="elevator-msg" target="_blank"> <i
			class="icon-feedback"></i> <span class="">意见反馈</span>
		</a> <a href="/help" class="elevator-faq" target="_blank"> <i
			class="icon-ques"></i> <span class="">帮助中心</span>
		</a> <a href="//www.imooc.com/mobile/app" target="_blank"
			class="elevator-app"> <i class="icon-appdownload"></i> <span
			class="">APP下载</span>
			<div class="elevator-app-box"></div>
		</a> <a href="javascript:void(0)" class="elevator-weixin no-goto"
			id="js-elevator-weixin"> <i class="icon-wxgzh"></i> <span
			class="">官方微信</span>
			<div class="elevator-weixin-box"></div>
		</a> <a href="javascript:void(0)" class="elevator-top no-goto"
			style="display: none" id="backTop"> <i class="icon-up2"></i> <span
			class="">返回顶部</span>
		</a>
	</div>
