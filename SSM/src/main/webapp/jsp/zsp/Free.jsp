    ...
    <div class="tool-right r">
    	<div class="tool-all">
            <ul id="js-columbd" class="all-cont" style="display:none;">
                                                                                                        ...
                                                                                                        <li><a data-id="0" href="/u/7299799/courses?sort=time&skill_id=0">全部课程</a></li>
                                                            <li><a data-id="7" href="/u/7299799/courses?sort=time&skill_id=7">HTML/CSS</a></li>
                                                            <li><a data-id="44" href="/u/7299799/courses?sort=time&skill_id=44">JavaScript</a></li>
                                                            <li><a data-id="1262" href="/u/7299799/courses?sort=time&skill_id=1262">CSS3</a></li>
...
<hr></hr>
	<div class="js-course-list my-space-course study-tl">
				<div class="clearfix tl-item  tl-item-first">
			            <span class="time" style="margin-top:30px;">
                <b>2018</b>
                <em>11月14日</em>
            </span>
                ...
                <ul class="clearfix">
                        ...
                        <div class="course-list-img l">
	                        <a href="/learn/81" target="_blank">
	                            <img width="200" height="113" alt="人人网评论功能" src="<%=path %>/imgs/zsp/renren.jpg" />
	                        </a>
                        </div>
                        <div class="course-list-cont">
                        	<h3 class="study-hd">
	                            <a href="/learn/81" target="_blank" style="font-size:20px;font-weight: bold;margin-left:30px;">人人网评论功能</a>
								...
								<span class="i-left span-common" style=" color:red;margin-left:30px;">已学23%</span>
								<span class="i-mid span-common" style=" margin-left:30px;">用时24分</span>
								<span class="i-right span-common" style=" margin-left:30px;">学习至4-1 使用JS实现分享点赞功能</span>
							</div>
								                        <div class="catog-points">
								<span class="i-left span-common" style="margin-right:20px;"><a href="/u/7299799/notepad/81" style=" margin-left:30px;">笔记 <i>0</i></a></span>
								<span class="i-mid span-common" style="margin-right:20px;"><a href="/u/7299799/course/81/codes">代码 <i>0</i></a></span>
								<span class="i-right span-common" style="margin-right:20px;"><a href="/u/7299799/course/81/questions">问答 <i>0</i></a></span>

							    							    <a href="/video/1145" target="_blank"   style="margin-left:100px; border: 1px solid #f01400; background-color: #fff;
    color: red;font-color:red;">继续学习</a>
