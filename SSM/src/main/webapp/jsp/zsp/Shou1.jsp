...
<div class="slider">
         ...
         <li>
            ...
            <a href="<%=path %>/jsp/zsp/Update.jsp" >
             <span>就业班</span><b class="icon-drop_right"></b>
                         ...
                         <li>
                <a href="<%=path %>/jsp/zsp/War.jsp" class="active">
	...
	<div class="tool-left l" style="margin-top:30px;height:40px;">
                 ...
                 <a href="<%=path %>/jsp/zsp/War.jsp" class="sort-item active" style="margin-right:30px;font-size:14px; color:#7f8082">我的实战</a>
                    <a href="<%=path %>/jsp/zsp/Shou1.jsp" class="sort-item " style="margin-right:30px;font-size:14px; color:#7f8082">我的收藏</a> 
    </div>
...
<hr></hr>
        ...
        <div class="not-conts" style="margin-top:20%;margin-left:40%;font-size:19px; color:#b9b9bc">
            你最近没有收藏任何课程，可以先<a href="/course/list" class="find-course" style=" color:red;">去找找课程</a>
        </div>
