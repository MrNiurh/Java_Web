			...
			<div class="user-info clearfix">
				<div class="user-pic" data-is-fans="0" data-is-follows="">
					<div class="user-pic-bg">
						<img class='img'
							src=" <%=path %><%=path %>/imgs/user/${user.headpic}" alt="" />
					</div>
					<!--user-pic-big end-->
				</div>
		...
		<div class="wrap">
			...
			<div class="slider">
				<ul>
					...
					<li><a href="<%=basePath%>user/Hand" class="active"> <span>手记</span><b
							class="icon-drop_right"></b>
					</a></li>
			...
			<div class="u-container">
				...
				<div class="nav" style="margin-top: 30px; height: 40px;">
					<a href="<%=basePath%>user/Hand " class="active"
						style="margin-right: 30px; font-size: 14px; color: #7f8082">我的文章</a>
					<a href="<%=basePath%>user/Tuijian "
						style="margin-right: 30px; font-size: 14px; color: #7f8082">我的推荐</a>
					<a href="<%=basePath%>user/Shoucang "
						style="margin-right: 30px; font-size: 14px; color: #7f8082">我的收藏</a>
					<a href="<%=basePath%>user/Pinglun "
						style="margin-right: 30px; font-size: 14px; color: #7f8082">我的评论</a>
				</div>
				<hr></hr>
				<div class="ques-list">
					<div class="nodata"
						style="margin-top: 20%; margin-left: 40%; font-size: 19px; color: #b9b9bc">
						你还没有评论，可以先<a href=" " target="_blank" style="color: red;">去看看文章</a>
					</div>
